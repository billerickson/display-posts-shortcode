...
Default: empty  
Example: [display-posts author_id="1"]
...
Example: [display-posts include_date="true" date_format="relative"]
...
Default: true  
Example: [display-posts include_excerpt="true" include_excerpt_dash="false"]
...
Default: empty  
Example: [display-posts post_type="page" post_parent__in="10, 20"]

**post_parent__not_in**
Exclude pages that have one of these parents.  
Default: empty  
Example: [display-posts post_type="page" post_parent__not_in="10,20"]
